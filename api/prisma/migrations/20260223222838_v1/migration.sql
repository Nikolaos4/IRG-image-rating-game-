...
-- CreateIndex
CREATE UNIQUE INDEX "game_public_id_key" ON "game"("public_id");
...
-- AddForeignKey
ALTER TABLE "game" ADD CONSTRAINT "game_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "user"("user_id") ON DELETE RESTRICT ON UPDATE CASCADE;
